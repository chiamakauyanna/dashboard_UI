...
const Direction = () => {
  return (
    <div className="mt-6 grid grid-cols-1 gap-6 rounded-[17px] bg-white p-4 xl:px-6 shadow xl:h-146 lg:grid-cols-2 lg:place-items-center">
      {/* Directions */}
      <div>
        <h2 className="mb-4 font-bold xl:text-[20px]">Directions</h2>
        <DirectionCard
          step="1"
...
Serve immediately."
      ...
      <div className="xl:max-w-121.25">
        {/* Tools and Equipments */}
        <div>
          <h2 className="mb-4 font-bold xl:text-[20px]">
            Tools and Equipments
          </h2>
        ...
        {/* Notes */}
        <div className="py-4">
          <h2 className="mb-4 font-bold xl:text-[20px]">Notes</h2>
          <IngredientsCard
