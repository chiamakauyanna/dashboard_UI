...
const UserDetails = () => {
  return (
    <div className="mt-4 flex h-153.5 flex-col justify-between rounded-[17px] bg-white px-6 py-12 shadow">
      <div>
        ...
        <div className="mt-6 flex items-center justify-center gap-6">
          <div className="border-secondary flex h-11.5 w-[148.11px] items-center justify-center gap-2 rounded-[10px] border">
            ...
            <p className="text-sm font-medium">55 kg</p>
          </div>

          <div className="border-secondary flex h-11.5 w-[148.11px] items-center justify-center gap-2 rounded-[10px] border">
            <img src={fire} alt="picture of a fire" />
            <p className="text-sm font-medium">167 cm</p>
          </div>

          <div className="border-secondary flex h-11.5 w-[148.11px] items-center justify-center gap-2 rounded-[10px] border">
            <img src={power} alt="picture signifying power" />
            <p className="text-sm font-medium">26 years</p>
          </div>
        </div>
      </div>
